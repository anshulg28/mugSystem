...
<script type="text/javascript" src="<?php echo base_url(); ?>asset/mobile/js/photoswipe.min.js"></script>
<script type="text/javascript" src="<?php echo base_url(); ?>asset/mobile/js/photoswipe-ui-default.min.js"></script>
